...
class TechnicalTest {
  ...
  List list = [
    ...
    // Exercise 50
    () {
      // ? Instruksi: Deklarasikan sebuah variabel "output" dengan tipe data List<int> dan beri nilai List<int> output = <int> dan beri nilai [9, 7, 5, 3, 1]
      // >>> Tulis jawabanmu di bawah ini
    ...
    () {
      ...
      // >>> Tulis jawabanmu di bawah ini
      List<String> input = <String>["apple", "banana", "cherry"];
      List<String>? output;
    ...
    () {
      ...
      // >>> Tulis jawabanmu di bawah ini
      List<double> input = <double>[3.14, 2.71, 1.618];
      List<double>? output;
    ...
    */
    ...
    () {
      ...
      bool? output = (input.toStringAsFixed(2).split('.')[1].length == 2);
    ...
    () {
      ...
      bool? output =
          (decimalIndex != -1 && inputString.length - decimalIndex - 1 == 3);
...
// Mendapatkan daftar values dari Map person
      List<dynamic> output =
          person.values.toList(); // Menggunakan .values dan toList()

// Memeriksa apakah output mengandung nilai yang diinginkan
    ...
    () {
      List<int> numbers = [1, 2, 3, 4, 5];
// Menghitung jumlah angka pada List numbers
      int output =
          numbers.length; // Menggunakan .length untuk mendapatkan jumlah elemen

// Memeriksa apakah output sama dengan 5
      return output == 5;
    },
    ...
    () {
      List<int> numbers = [1, 2, 3, 4, 5];
// Menghitung jumlah total dari semua angka pada List numbers
      int output = numbers.reduce((a, b) =>
          a + b); // Menggunakan reduce untuk menjumlahkan semua elemen

// Memeriksa apakah output sama dengan 15
      return output == 15;
    },
    ...
    () {
      List<int> numbers = [1, 2, 3, 4, 5];
// Menghitung jumlah total dari semua angka pada List numbers dengan nilai awal 10
      int output = numbers.fold(
          10,
          (sum, number) =>
              sum + number); // Menggunakan fold dengan nilai awal 10

// Memeriksa apakah output sama dengan 25
      return output == 25;
    },
...
// Memeriksa apakah output sama dengan 25
    ...
    () {
      List<int> numbers = [1, 2, 3, 4, 5];
// Mengambil setiap angka ganjil pada List numbers
      List<int> output = numbers
          .where((number) => number % 2 != 0)
          .toList(); // Memfilter angka ganjil

// Memeriksa kondisi yang diinginkan
...
// Mengurutkan List fruits secara ascending
      fruits.sort(); // Mengurutkan daftar secara ascending
...
// Mengurutkan List fruits secara descending
      fruits.sort((a, b) => b.compareTo(a)); // Mengurutkan secara descending
...
// Memeriksa kondisi yang diinginkan
    ...
    () {
      List<int> numbers = [1, 2, 3, 4, 5];
// Memeriksa apakah semua angka pada List numbers adalah angka positif
...
// Mengembalikan output
    ...
    () {
      List<int> numbers = [-1, -2, 3, 4, 5];
// Memeriksa apakah ada angka negatif pada List numbers
...
// Menggabungkan semua nama menjadi satu string dengan koma di antara nama-nama
...
// Mengembalikan hasil perbandingan
    ...
    () {
      String text = "Dart";
// Membalikkan urutan karakter pada variable text
...
// Mengembalikan hasil perbandingan
    ...
    () {
      List<int> numbers = [1, 2, 3, 4, 5];
// Mengambil nilai maksimum dari List numbers
...
// Mengembalikan hasil perbandingan
    ...
    () {
      List<int> numbers = [1, 2, 3, 4, 5];
// Mengambil nilai minimum dari List numbers
      int output = numbers.reduce((a, b) => a < b ? a : b);
...
// Mengurutkan List numbers secara ascending
      numbers.sort();
...
// Mengembalikan hasil perbandingan
    ...
    () {
      List<int> numbers = [1, 2, 3, 4, 5];
// Mengurutkan List numbers secara descending
...
// Mengembalikan hasil perbandingan
    ...
    () {
      String text = "Dart is awesome";
// Memeriksa apakah kata "is" muncul pada variable text
...
// Mengembalikan hasil
    ...
    () {
      String text = "Dart is awesome";
// Memeriksa apakah variable text diakhiri dengan kata "awesome"
...
// Mengembalikan hasil
    ...
    () {
      String text = "dart is awesome";
      // Mengubah variable text menjadi huruf besar semua.
      String output = text.toUpperCase();
      return output == "DART IS AWESOME";
    },
    ...
    () {
      String text = "dart is awesome";
      // Mengubah karakter pertama pada variable text menjadi huruf besar.
      String output = text[0].toUpperCase() + text.substring(1);
      return output == "Dart is awesome";
    },
    ...
    () {
      String text = "dart is awesome";
      // Mengubah karakter terakhir pada variable text menjadi huruf besar.
      String output = text.substring(0, text.length - 1) +
          text[text.length - 1].toUpperCase();
      return output == "dart is awesomE";
    },
    ...
    () {
      String text = "Dart is awesome";
      // Mengambil 10 karakter pertama dari variable text.
      String output = text.substring(0, 10);
      return output == "Dart is aw";
    },
    ...
    () {
      ...
      bool output = containsX && containsA;
      return output == false;
    },
    ...
    () {
      ...
      return combinedText == "Dart is awesome and Flutter";
    },
    ...
    () {
      ...
      for (String fruit in fruits) {
        if (fruit == 'kiwi') {
          output = true;
          break; // Menghentikan loop karena 'kiwi' sudah ditemukan
        }
      }
      // --- End of Answer ---
    ...
    () {
      ...
      for (int number in numbers) {
        if (number == target) {
          exists = true;
          break; // Hentikan loop karena target sudah ditemukan
        }
      }
      // --- End of Answer ---
    ...
    () {
      ...
      for (int number in numbers) {
        if (number % 3 != 0) {
          ...
          break; // Hentikan loop lebih awal jika ada angka yang tidak habis dibagi 3
        }
      }
      // --- End of Answer ---
    ...
    () {
      ...
      for (int i = 0; i < fruits.length; i++) {
        if (fruits[i] == target) {
          found = true; // Jika target ditemukan, set found ke true
          break; // Keluar dari loop karena target sudah ditemukan
        }
      }
      // --- End of Answer ---
    ...
    () {
      ...
      // >>> Tulis kode for loop di sini
      for (int i = 0; i < fruits.length; i++) {
        joinedFruits += fruits[i]; // Menambahkan item ke joinedFruits
      }
      // --- End of Answer ---
    ...
    () {
      ...
      for (int i = 0; i < numbers.length; i++) {
        product *= numbers[i]; // Mengalikan elemen saat ini dengan product
      }
      // --- End of Answer ---
    ...
    () {
      ...
      for (int i = numbers.length - 1; i >= 0; i--) {
        reversedNumbers
            .add(numbers[i]); // Menambahkan elemen ke reversedNumbers
      }
      // --- End of Answer ---
    ...
    () {
      ...
      for (int i = 0; i < numbers.length; i++) {
        if (numbers[i] % 2 != 0) {
          ...
          oddNumbers.add(numbers[i]); // Menambahkan angka ganjil ke oddNumbers
        }
      }
      // --- End of Answer ---
    ...
    () {
      ...
      for (int i = 0; i < sales.length; i++) {
        salesTotal += sales[i]; // Menambahkan elemen saat ini ke salesTotal
      }
      // --- End of Answer ---
...
// Menghitung rata-rata penjualan
    ...
    () {
      ...
      for (int i = 1; i < productPrices.length; i++) {
        ...
        if (productPrices[i] > expensiveProduct) {
          // Jika harga saat ini lebih mahal
          expensiveProduct = productPrices[i]; // Update expensiveProduct
        }
      }
      // --- End of Answer ---
    ...
    () {
      ...
      for (int i = 0; i < products.length; i++) {
        productCount[products[i]] = (productCount[products[i]] ?? 0) + 1;
      }
// Menentukan produk favorit
      int maxCount = 0;
    ...
    () {
      ...
      for (var transaksi in transactions) {
        totalPendapatan += transaksi["amount"] * transaksi["price"];
      }
      // --- End of Answer ---
    ...
    () {
      ...
      return index == 2; // Check if the index found is 2
    },
