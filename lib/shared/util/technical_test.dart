...
class TechnicalTest {
  ...
  List list = [
    ...
    () {
      ...
      // >>> Tulis jawabanmu di bawah ini
      List<String> output = <String>["apple", "banana", "cherry", "date", "fig"];
      // --- End of Answer ---
    ...
    () {
      ...
      // >>> Tulis jawabanmu di bawah ini
      List<String> output = <String>["grape", "kiwi", "lemon", "mango", "orange"];
      // --- End of Answer ---
    ...
    () {
      ...
      // >>> Tulis jawabanmu di bawah ini
      List<String> output = <String>["pear", "quince", "raspberry", "strawberry", "tangerine"];
      // --- End of Answer ---
    ...
    () {
      ...
      output = "${input.year.toString().padLeft(4, '0')}-${input.month.toString().padLeft(2, '0')}-${input.day.toString().padLeft(2, '0')}";
